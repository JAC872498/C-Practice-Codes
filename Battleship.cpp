...
int main(){
    ...
    int enemyGuess[]={0,0};
    int turns=8;
    enemyGrid[eShip1[0]][eShip1[1]]=";";
    enemyGrid[eShip2[0]][eShip2[1]]=";";
    enemyGrid[eShip3[0]][eShip3[1]]=";";
    enemyGrid[eShip4[0]][eShip4[1]]=";";
    enemyGrid[eShip5[0]][eShip5[1]]=";";
